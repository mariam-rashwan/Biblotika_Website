        ...
        <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
           @csrf
            ...
            <div class="form-head " style="background-color: #358a99; color: white;">
                <center><h4 class="text text-light">Upload your book</h4></center>
            </div>
            <br><br>
            ...
            <div class="form-group col-10 ">
                ...
                <input type="text" class="form-control" placeholder="exchange / Sell (for how much?)" name="trade_type">
            </div>
            <div class="form-group col-10 ">
                <label for="" class="form-label float-start">Your location :</label>
                <input type="text" class="form-control" placeholder="Cairo / Alexandria" name="city">
            </div>
            <div class="form-group col-10 ">
                <label for="" class="form-label float-start">Your Phone number :</label>
                <input type="number" class="form-control" placeholder="0112848877002" name="phone_number">
            </div>
            <div class="form-group col-10 ">
            ...
            <div class="btn col-10 ">
                <button class="btn  form-button col-12" style="background-color: #358a99; color: white;">
                     <input type="submit" value="POST NOW" style="background-color: #358a99; color: white;border:none;">
                </button>
            </div>
